...
dot.addEventListener("click", function() {
     ...
     if (!content.textContent.endsWith(".") && content.textContent && !content.textContent.endsWith("(")
        && !content.textContent.includes(".") && !content.textContent.endsWith("%") && !content.textContent.endsWith(")") || content.textContent.includes("+") || content.textContent.includes("-")
...
bracket.addEventListener("click", function() {
    ...
    || content.textContent.endsWith("9") || content.textContent.endsWith(")"))) {
        content.textContent += "*("
    ...
    && !content.textContent.endsWith("9")) {
        content.textContent += "("
    } else if (!content.textContent.endsWith(")") && content.textContent.includes("(") && !content.textContent.endsWith("(")) {
        content.textContent += ")"
    }
    rDiscard()
})
...
document.addEventListener("keydown", function(event) {
    if (event.key == "1") {
        ...
        rZero()
        if ((!content.textContent.includes("(")) && (content.textContent.endsWith("1") || content.textContent.endsWith("2")
             || content.textContent.endsWith("3") || content.textContent.endsWith("0") || content.textContent.endsWith(")")
             || content.textContent.endsWith("3") || content.textContent.endsWith("4") || content.textContent.endsWith("5")
             || content.textContent.endsWith("6") || content.textContent.endsWith("7") || content.textContent.endsWith("8")
             || content.textContent.endsWith("9"))) {
        content.textContent += "*("
